...
// Helper to sanitize text for use in JavaScript string literals
                ...
                <div id="clientsList" class="space-y-4">
                    ...
                    <?php else: ?>
                        <?php foreach ($clients as $client): ?>
                            <?php 
                                $safePhone = js_escape($client['phone'] ?? '');
                                $safeName = js_escape($client['name']);
                            ?>
                            <div class="appointment-card bg-blue-50 border-blue-200">
                                ...
                                <?php endif; ?>
                                <div class="flex justify-end gap-3 mt-6 pt-4 border-t">
                                    <button onclick="sendClientWhatsApp('<?php echo $safePhone; ?>', '<?php echo $safeName; ?>')" class="admin-btn bg-green-500 hover:bg-green-600">
                                    ...
                                    <button onclick="editClient(<?php echo $client['client_id']; ?>)" class="admin-btn bg-blue-600 hover:bg-blue-700">
                                        <?php echo svg_icon('edit.svg', 'btn-icon'); ?>
                                        Editar
                                    </button>
                                    <button onclick="deleteClient(<?php echo $client['client_id']; ?>)" class="admin-btn bg-red-500 hover:bg-red-600">Deletar</button>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
