...
export default function RegisterEmployeesPage() {
  ...
  const MASTER_PASSWORD = "Admin_@CS_funcionario2025%_Ja"
  ...
  const handleAddEmployee = () => {
    if (!formData.name.trim() || !formData.email.trim() || !formData.cpf.trim() || !formData.password.trim()) {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <Card className="p-8 max-w-md w-full">
          <h1 className="text-3xl font-bold text-foreground mb-2 text-center">Cadastro de Funcionários</h1>
          <p className="text-center text-muted-foreground mb-6">Área restrita - acesso protegido</p>
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Total: {employees.length} funcionários cadastrados</p>
            </div>
          </div>
          <Button 
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Digite uma senha segura para acesso ao painel"
                  className="w-full px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <p className="text-xs text-muted-foreground mt-1">Esta senha será usada para acessar o painel administrativo</p>
              </div>
            </div>
